...
> - Tài liệu yêu cầu: [`feedback_17_8/menu chỉ hiển thị 3 items.md`](./menu%20ch%E1%BB%89%20hi%E1%BB%83n%20th%E1%BB%8B%203%20items.md)  
> - Bản phác thảo Group xe: [`feedback_17_8/group_theo_xe.png`](./group_theo_xe.png)  
> - Mẫu tem nhận diện thực tế: [`feedback_17_8/tem_nhan_dien.png`](./tem_nhan_dien.png)  
...
> - Trạng thái: **HOÀN THÀNH TOÀN BỘ VÀ BUILD THÀNH CÔNG (100% COMPLETED)**
...
- [x] **TASK-BE-01: Gỡ bỏ ràng buộc Unique Constraint trên `orderCode`**
  ...
  - **Files**:
    ...
    - Tạo migration TypeORM mới: `DropOrderCodeUniqueConstraint.ts`.
...
- [x] **TASK-BE-02: Bổ sung trường Quản lý Tồn kho & Đợt xuất nhập (Partial Inventory Fields)**
  ...
  - **Files**:
    ...
    - Tạo migration TypeORM: `AddInventoryQuantitiesToOrder.ts`.
